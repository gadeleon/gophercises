...
**NOTE:** _CSV files may have questions with commas in them. Eg:_ `"what 2+2, sir?",4` _is a valid row in a CSV. I suggest you look into the CSV package in Go and don’t try to write your own CSV parser._
